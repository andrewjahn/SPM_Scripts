...
if exist(['C:\data\sub-' subject '\func\sub-' subject '_task-flanker_run-1_bold.nii']) == 0
    display('Run 1 has not been unzipped; unzipping now')
    gunzip(['C:\data\sub-' subject '\func\sub-' subject '_task-flanker_run-1_bold.nii.gz'])
else
    display('Run 1 is already unzipped; doing nothing')
end

if exist(['C:\data\sub-' subject '\func\sub-' subject '_task-flanker_run-2_bold.nii']) == 0
    display('Run 2 has not been unzipped; unzipping now')
    gunzip(['C:\data\sub-' subject '\func\sub-' subject '_task-flanker_run-2_bold.nii.gz'])
else
    display('Run 2 is already unzipped; doing nothing')
end

if exist(['C:\data\sub-' subject '\anat\sub-' subject '_T1w.nii']) == 0
    display('Anatomical image has not been unzipped; unzipping now')
    gunzip(['C:\data\sub-' subject '\anat\sub-' subject '_T1w.nii.gz'])
else
...
matlabbatch{1}.cfg_basicio.file_dir.file_ops.cfg_named_file.files = {
                                                                     {['C:\data\sub-' subject '\func\sub-' subject '_task-flanker_run-1_bold.nii']}
                                                                     {['C:\data\sub-' subject '\func\sub-' subject '_task-flanker_run-2_bold.nii']}
                                                                     }';
...
matlabbatch{4}.spm.spatial.coreg.estwrite.source = {['C:\data\sub-' subject '\anat\sub-' subject '_T1w.nii,1']};
...
matlabbatch{5}.spm.spatial.preproc.channel.vols = {['C:\data\sub-' subject '\anat\rsub-' subject '_T1w.nii,1']};
...
matlabbatch{5}.spm.spatial.preproc.tissue(1).tpm = {['C:\SPM12\tpm\TPM.nii,1']};
...
matlabbatch{5}.spm.spatial.preproc.tissue(2).tpm = {['C:\SPM12\tpm\TPM.nii,2']};
...
matlabbatch{5}.spm.spatial.preproc.tissue(3).tpm = {['C:\SPM12\tpm\TPM.nii,3']};
...
matlabbatch{5}.spm.spatial.preproc.tissue(4).tpm = {['C:\SPM12\tpm\TPM.nii,4']};
...
matlabbatch{5}.spm.spatial.preproc.tissue(5).tpm = {['C:\SPM12\tpm\TPM.nii,5']};
...
matlabbatch{5}.spm.spatial.preproc.tissue(6).tpm = {['C:\SPM12\tpm\TPM.nii,6']};
...
matlabbatch{9}.spm.stats.fmri_spec.dir = {['C:\data\sub-' subject '\1stLevel']};
...
data_incongruent_run1 = load(['C:\data\sub-' subject '\func\incongruent_run1.txt']);
...
data_congruent_run1 = load(['C:\data\sub-' subject '\func\congruent_run1.txt']);
...
%%
data_incongruent_run2 = load(['C:\data\sub-' subject '\func\incongruent_run2.txt']);
...
%%
data_congruent_run2 = load(['C:\data\sub-' subject '\func\congruent_run2.txt']);
